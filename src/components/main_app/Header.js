        ...
        <div id='header' className = 'fixed top-0  w-full flex justify-center h-40 items-center transitions-all bg-transparent z-20' >
            <div className = 'fixed top-0 flex justify-between items-center px-5 md:px-10 w-full h-32 bg-transparent ' >
                ...
                <div className = 'flex-row justify-around z-20 items-center w-52 bg-transparent hidden md:flex animate__animated animate__fadeIn'>
                    ...
                    <p className="font-sans text-base text-main_yellow tracking-normal">Available for New Projects</p>
                </div>

                <div className={`${menu? 'mt-28' : ''}`}>
                    <div className = {`flex items-center justify-between bg-main_yellow z-20 ${menu? 'rounded-t-lg' : 'rounded-lg'} py-4 px-3 w-32 md:w-40 md:mr-7  ${menu? 'mt-20' : ''}`}
                    onClick={showMenu}>
