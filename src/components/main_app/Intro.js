...
const Intro = () => {
    return (
        <div className = 'w-full flex flex-col lg:flex-row items-center' style={{backgroundColor: 'rgba(2,27,41)'}}>
            ...
            <div className='flex flex-col md:ml-10  w-11/12 lg:w-1/2 '  >
                <div className = 'my-20'>
                    <p className="font-sans w-11/12 text-3xl ml-7 md:text-5xl  lg:text-6xl font-bold text-white tracking-normal">
                        Why I fell in love with photography
                    </p>
                    <div className = 'font-sans text-stone-400	text-base ml-7 mt-10 w-11/12'
                ...
                <div className = 'bg-amber-500 p-4 w-2/5 md:w-3/5 ml-7 flex items-center justify-around rounded-lg uppercase mb-20 text-sm font-bold '>
                    WORK WITH ME
                </div>
            </div>
        </div>
